        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link to="https://www.facebook.com/share/177VD2zZ2H/" className="text-muted-foreground hover:text-primary">
              ...
              <Link to="https://www.instagram.com/georeseaux" className="text-muted-foreground hover:text-primary">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
                    fillRule="evenodd"
              ...
              <Link to="https://www.linkedin.com/company/georeseaux" className="text-muted-foreground hover:text-primary">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
